...
let ProjectDashboardService = class ProjectDashboardService extends app_app_service__WEBPACK_IMPORTED_MODULE_4__["appServiceBase"] {
    /**
     * Constructor
     *
     * @param {HttpClient} _httpClient
     */
    constructor(_httpClient, _matSnackBar, _router) {
        super(_httpClient, _matSnackBar, _router);
        this._httpClient = _httpClient;
        this._matSnackBar = _matSnackBar;
        this._router = _router;
        this.apiUrlGetSalesPerformanceByYearMonth = this.host + "admin/Analytics/GetSalesPerformanceByYearMonth";
        this.apiUrlGetInternalExternalSalesPerformance = this.host + "admin/Analytics/GetInternalExternalSalesPerformance";
        this.apiUrlGetTeamMemberSalesPerformance = this.host + "admin/Analytics/GetTeamMemberSalesPerformance";
        this.apiUrlGetSalesPerformanceByStatus = this.host + "admin/Analytics/GetSalesPerformanceByStatus";
        this.apiUrlGetRecentOrderInfo = this.host + "admin/Analytics/GetRecentOrderInfo";
    }
    /**
     * Resolver
     *
    ...
    GetSalesPerformanceByYearMonth() {
        return new Promise((resolve, reject) => {
    ...
    GetInternalExternalSalesPerformance() {
        return new Promise((resolve, reject) => {
